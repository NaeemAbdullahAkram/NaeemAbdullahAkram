    ...
    <div class="Box-body p-4">
        <div class="d-flex flex-justify-between">
            <div class="text-mono text-small mb-3">
                <a href="/NaeemAbdullahAkram/NaeemAbdullahAkram"
                    class="no-underline Link--primary">NaeemAbdullahAkram</a><span class="color-fg-muted d-inline-block"
                    style="padding:0px 2px;">/</span>README<span class="color-fg-muted">.md</span>
            </div>
        </div>
        ...
        <ul dir="auto">
            <li>
                <p dir="auto">🎓 <strong>Formal Education:</strong> Senior year student of Computer Science at Lahore
            ...
            <li>
                <p dir="auto">📝 <strong>Share Knowledge:</strong> I regularly Create new Web Designs.</p>
            </li>
            <li>
        ...
        <div class="markdown-heading" dir="auto">
            <h1 class="heading-element" dir="auto"> Look at My some Latest Projects 📚 </h1><a
